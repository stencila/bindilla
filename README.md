...
As it happens, [yes](https://www.youtube.com/watch?v=8s3UogfAGg0)!
...
<h5 id="bindilla.host_http_server.EnvironHandler.post">post</h5>
...
<h5 id="bindilla.host_http_server.EnvironHandler.delete">delete</h5>
